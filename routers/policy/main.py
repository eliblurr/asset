...
@router.post('/', response_model=schemas.Policy, status_code=201, name='Policy')
...
@router.patch('/{id}', response_model=schemas.Policy, name='Policy')
...
@router.delete('/{id}', name='Policy', status_code=204)
