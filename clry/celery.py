...
app = Celery('eAsset', backend="rpc://e-asset-user:password@localhost:5672/e-asset-host", broker="amqp://e-asset-user:password@localhost:5672/e-asset-host", include=['clry.tasks'])
