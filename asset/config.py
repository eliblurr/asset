...
class Settings(BaseSettings):
    ...
    EMAIL_CODE_DURATION_IN_MINUTES: float = 15
    ACCESS_TOKEN_DURATION_IN_MINUTES: float = 60
    REFRESH_TOKEN_DURATION_IN_MINUTES: float = 600
    PASSWORD_RESET_TOKEN_DURATION_IN_MINUTES: float = 15
    ACCOUNT_VERIFICATION_TOKEN_DURATION_IN_MINUTES: float = 15
